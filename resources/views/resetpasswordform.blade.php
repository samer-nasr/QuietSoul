    ...
    <div class="circle-content">
      ...
      <div class="container">
        <form action="{{ route('password.store') }}" method="POST">
          ...
          <h2> <input type="email" name="email" placeholder="Enter your email" required value="{{ $request->email }}" readonly/> </h2><br>
          <label for="">Password</label>
          <h2> <input type="password" name="password" placeholder="" required /> </h2><br>
          @error('password')
            <div class="alert alert-danger">{{ $message }}</div>
          @enderror
          <label for="">Confirm Password</label>
          <h2> <input type="password" name="password_confirmation" placeholder="" required /> </h2><br>
          <h3> <button type="submit">Change Password</button> </h3><br>
        </form>
